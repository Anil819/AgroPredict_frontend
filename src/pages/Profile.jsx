        ...
        <div className="flex-1 card p-8 space-y-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 pb-8 border-b border-surface-200 dark:border-dark-border">
            <div className="relative group cursor-pointer">
              <div className="w-24 h-24 bg-primary-600 text-white rounded-full flex items-center justify-center text-4xl font-bold shadow-lg">
            ...
            <div className="text-center md:text-left">
              ...
              <button className="mt-3 text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400">Edit Photo</button>
            </div>
          </div>
