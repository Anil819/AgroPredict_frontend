...
import { dashboardStats, weatherData, cropGrowthData, soilData, IMAGES } from '@/utils/mockData';
...
export default function Dashboard() {
  ...
  const dummyStats = dashboardStats || [
    { title: 'Total Yield', value: '4.2 Tons', icon: <ThermometerSun />, trend: '+12%', color: 'bg-green-100 text-green-600' },
    { title: 'Soil Moisture', value: '68%', icon: <Droplets />, trend: 'Good', color: 'bg-blue-100 text-blue-600' },
    { title: 'Temperature', value: '24°C', icon: <ThermometerSun />, trend: 'Optimal', color: 'bg-orange-100 text-orange-600' },
    { title: 'Wind Speed', value: '12 km/h', icon: <Wind />, trend: 'Moderate', color: 'bg-teal-100 text-teal-600' },
  ];

  const dummyWeather = weatherData?.forecast || [
    { day: 'Mon', temp: 24, icon: 'sun', condition: 'Clear' },
    { day: 'Tue', temp: 22, icon: 'cloud', condition: 'Cloudy' },
    { day: 'Wed', temp: 20, icon: 'rain', condition: 'Rain' },
    { day: 'Thu', temp: 23, icon: 'sun', condition: 'Sunny' },
    { day: 'Fri', temp: 25, icon: 'sun', condition: 'Clear' },
    { day: 'Sat', temp: 26, icon: 'sun', condition: 'Clear' },
    { day: 'Sun', temp: 24, icon: 'cloud', condition: 'Cloudy' },
  ];

  const chartData = cropGrowthData || [
    { name: 'Week 1', growth: 10 },
    { name: 'Week 2', growth: 25 },
    { name: 'Week 3', growth: 45 },
    { name: 'Week 4', growth: 60 },
    { name: 'Week 5', growth: 80 },
    { name: 'Week 6', growth: 95 },
  ];
